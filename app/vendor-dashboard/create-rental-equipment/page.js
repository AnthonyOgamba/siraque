    ...
    <main className="min-h-screen bg-[#f9f9fb] text-[#2d3338]">
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200/15 shadow-sm flex justify-between items-center px-8 h-16">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a className="text-slate-500 hover:text-orange-600 transition-colors duration-300 font-medium text-sm" href="#">
              Marketplace
            </a>
            <a className="text-slate-500 hover:text-orange-600 transition-colors duration-300 font-medium text-sm" href="#">
              Analytics
        ...
        <div className="flex items-center gap-4">
          <button className="p-2 text-slate-500 hover:text-orange-600 transition-colors">🔔</button>
          <button className="p-2 text-slate-500 hover:text-orange-600 transition-colors">❓</button>
      ...
      <aside className="fixed left-0 top-0 h-screen w-64 pt-20 bg-slate-50 flex flex-col p-4 gap-2">
        ...
        <nav className="flex-1 space-y-1">
          <a className="flex items-center gap-3 px-3 py-2 text-slate-500 hover:bg-slate-100 rounded-lg" href="#">
            <span>📊</span>
            <span className="font-medium text-sm">Dashboard</span>
          </a>
          <a className="flex items-center gap-3 px-3 py-2 text-orange-600 font-semibold bg-white shadow-sm rounded-lg" href="#">
            <span>🏷️</span>
